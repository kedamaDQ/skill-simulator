    ...
    <div className='modal-about'>
      <section className='text-modal'>
        ...
        <dl className='history'>
          <dt>2019-10-24 (v1.1.16)</dt>
          <dd><p>ドラゴンクエスト X Ver.5.0 のリリースに伴い更新を終了します。約1年7か月の間、ありがとうございました!!</p></dd>
          <dt>2019-07-13 (v1.1.15)</dt>
          <dd><p>依存ライブラリをアップデートしました。</p></dd>
          <dt>2019-06-26 (v1.1.14)</dt>
          <dd><p>タサいバグがあったので修正しました……</p></dd>
          <dt>2019-06-26 (v1.1.13)</dt>
          <dd><p>Lv.110 と 武器スキル 200 に正式対応しました。</p>
          <p>Lv.109, 110 で遊び人は +3, +4 、その他の職は +2, +3 とスキルポイントが増加します。</p></dd>
          <dt>2019-06-11 (v1.1.13rc1)</dt>
          <dd><p>Lv.110 と 武器スキル 200 に暫定対応しました。</p>
          <p>Lv.109, Lv.110 では、暫定的にスキルポイントが 2, 2 と増えるようにしています。(少し控え目にしています)</p>
          <p>また、現状ではレイアウトの微調整までは実施していないため、スキルポイントを割り振る小窓でスクロールバーが出てしまう場合があります。v1.1.13 正式リリースで対応予定です。</p></dd>
          <dt>2019-05-29 (v1.1.12)</dt>
          <dd><p>ローカルストレージにセーブしてあるデータの表示順序を変更できるようにしました。(Special thanks to <a href="https://twitter.com/AsellusValkyrie/status/1132636906880086016" target="_blank" rel="noreferrer noopener">@AsellusValkyrie</a> !!)</p>
          <p>ただし現状ではデータを新規に作成した直後だけはソートが崩れてしまいます。その場合はいちど「セーブとロード」の小窓を閉じると正常に動作するようになります。</p>
          <p>また、漢字のソートになるとちょっと順序が怪しいと思います……ひらがなカタカナ数字アルファベットあたりは正しくソートできますが、半角全角や大文字小文字は区別します。</p></dd>
          <dd><p>脆弱性(CVE-2018-20834)に対応しました。</p></dd>
          <dd><p>依存ライブラリをアップデートしました。それに伴って react-select のバグが改善されたようなので、画面の下の方でドロップダウンリストを開いた時にはリストが上側に展開するようにちょっと挙動を変更しました。</p></dd>
          <dd></dd>
          <dt>2019-03-31 (v1.1.11)</dt>
          <dd><p>リリースをミスったのでもう1個バージョンを上げます orz</p></dd>
          <dt>2019-03-31 (v1.1.10)</dt>
          <dd><p>マスタースキルポイント 30 に対応しました。</p><p>……今の今までマスタースキルポイントの追加があるの知りませんでしたｗ</p></dd>
